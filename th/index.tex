...
\ifPDFTeX\else  
  ...
  \ifXeTeX
    \usepackage{xeCJK}
    \setCJKmainfont[]{TH Sarabun New}
          \fi
  \ifLuaTeX
    \usepackage[]{luatexja-fontspec}
    \setmainjfont[]{TH Sarabun New}
  \fi
\fi
...
\hypersetup{
  pdftitle={พจนานุกรมผู้สร้าง},
  pdfauthor={บุเด เสถบุตร-ปิคซิน},
  hidelinks,
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{เกี่ยวกับหนังสือเล่มนี้}, bottomtitle=1mm, left=2mm, coltitle=black, colback=white, arc=.35mm, titlerule=0mm, rightrule=.15mm, opacityback=0, toprule=.15mm]
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{_resources/assets/images/ch1-SoSethaputra1.jpeg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{./_resources/assets/images/ch5-BangKwang.jpeg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{_resources/assets/images/ch6-dictionarysample.jpeg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{_resources/assets/images/ch8-DaringEscape.jpeg}}
