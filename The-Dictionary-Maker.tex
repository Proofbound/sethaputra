...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, titlerule=0mm, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{About This Book}, coltitle=black, rightrule=.15mm, left=2mm, opacityback=0]
